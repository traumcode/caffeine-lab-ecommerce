    ...
    return(
        ...
        <div className="Shop-Menu">
            <ul>
                ...
                <Link className="second-row-item"  style={{textDecoration:"none"}}to="/shop/Espresso"><li className="second-row-item" style={{fontWeight: (path=== "/shop/Ethiopia") ? '800' : "500"}}>ESPRESSO</li></Link>
                <Link className="second-row-item"  style={{textDecoration:"none"}}to="/shop/Decaf"><li className="second-row-item" style={{fontWeight: (path=== "/shop/Guatemala") ? '800' : "500"}}>DECAF</li></Link>
            </ul>
